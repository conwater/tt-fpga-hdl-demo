...
// For /fpga_pins/fpga$clk_disp.
logic FpgaPins_Fpga_clk_disp_a0,
      FpgaPins_Fpga_clk_disp_a1,
      FpgaPins_Fpga_clk_disp_a2;

// For /fpga_pins/fpga$digit.
logic [3:0] FpgaPins_Fpga_digit_a0;

// For /fpga_pins/fpga$dsw.
logic [3:0] FpgaPins_Fpga_dsw_a0;

// For /fpga_pins/fpga$ones.
logic FpgaPins_Fpga_ones_a0;

// For /fpga_pins/fpga$playing.
logic FpgaPins_Fpga_playing_a0,
      FpgaPins_Fpga_playing_a1;
...
logic FpgaPins_Fpga_tens_a0;
   ...
   //
      ...
      //
         ...
         // Staging of $playing.
         always_ff @(posedge clk) FpgaPins_Fpga_playing_a1 <= FpgaPins_Fpga_playing_a0;
   ...
   if (1) begin : DEBUG_SIGS_GTKWAVE
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            assign \//@0$clk_disp = FpgaPins_Fpga_clk_disp_a0;
            (* keep *) logic [3:0] \//@0$digit ;
            assign \//@0$digit = FpgaPins_Fpga_digit_a0;
            (* keep *) logic [3:0] \//@0$dsw ;
            assign \//@0$dsw = FpgaPins_Fpga_dsw_a0;
            (* keep *) logic  \//@0$ones ;
            assign \//@0$ones = FpgaPins_Fpga_ones_a0;
            (* keep *) logic  \//@0$playing ;
            assign \//@0$playing = FpgaPins_Fpga_playing_a0;
            (* keep *) logic  \//@0$ready ;
            assign \//@0$ready = FpgaPins_Fpga_ready_a0;
            (* keep *) logic  \//@0$reset ;
      ...
      //_/fpga_pins
         ...
         //_/fpga
            //_\source top.tlv 48   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+my_design.
               ...
               assign FpgaPins_Fpga_btn_a0[3:0] = ui_in[7:4];
               assign FpgaPins_Fpga_dsw_a0[3:0] = ui_in[3:0];
            
               // divides clock for better switching on dual seven-segment
               assign FpgaPins_Fpga_clk_disp_a0 = FpgaPins_Fpga_clk_disp_a2 ? 1'b0 : FpgaPins_Fpga_clk_disp_a2 + 1'b1;
            
               assign FpgaPins_Fpga_digit_a0[3:0] = FpgaPins_Fpga_clk_disp_a0 ? FpgaPins_Fpga_tens_a0 : FpgaPins_Fpga_ones_a0;
            
               // decodes either tens or ones place to the seven-segments
               assign uo_out[7:0] = {FpgaPins_Fpga_clk_disp_a0,
                  FpgaPins_Fpga_digit_a0 == 4'd0 ? 7'b0111111 :
                  FpgaPins_Fpga_digit_a0 == 4'd1 ? 7'b0000110 :
                  FpgaPins_Fpga_digit_a0 == 4'd2 ? 7'b1011011 :
                  FpgaPins_Fpga_digit_a0 == 4'd3 ? 7'b1001111 :
                  FpgaPins_Fpga_digit_a0 == 4'd4 ? 7'b1100110 :
                  FpgaPins_Fpga_digit_a0 == 4'd5 ? 7'b1101101 :
                  FpgaPins_Fpga_digit_a0 == 4'd6 ? 7'b1111101 :
                  FpgaPins_Fpga_digit_a0 == 4'd7 ? 7'b0000111 :
                  FpgaPins_Fpga_digit_a0 == 4'd8 ? 7'b1111111 :
                  FpgaPins_Fpga_digit_a0 == 4'd9 ? 7'b1101111 :
                                   7'b0000000};
            
               // connects Tiny Tapeout outputs
               ...
               assign FpgaPins_Fpga_playing_a0 = FpgaPins_Fpga_reset_a0 ? 1'b0 : FpgaPins_Fpga_playing_a1 ? 1'b1 : (FpgaPins_Fpga_ready_a0 && (FpgaPins_Fpga_btn_a0 == 4'b0));
            
               assign FpgaPins_Fpga_tens_a0 =
                  FpgaPins_Fpga_ready_a0 && !FpgaPins_Fpga_playing_a0 ? 4'd1 :
                  FpgaPins_Fpga_playing_a0 ? 4'd2 : 4'd0;
               assign FpgaPins_Fpga_ones_a0 =
                  FpgaPins_Fpga_ready_a0 && !FpgaPins_Fpga_playing_a0 ? 4'd1 :
                  FpgaPins_Fpga_playing_a0 ? 4'd2 : 4'd0;
            //_\end_source

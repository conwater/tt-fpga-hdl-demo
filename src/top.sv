...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 275 as: m5+board(/top, /fpga, 7, $, , my_design)
               ...
               //_|time
                  //_@0
                     ...
                     assign FpgaPins_Fpga_TIME_p1_score_a0[7:0] =
                        ...
                        (FpgaPins_Fpga_TIME_p1_ans_a0[7:4]>FpgaPins_Fpga_TIME_rand_goal_a0[7:4]) ? {FpgaPins_Fpga_TIME_p1_ans_a0[7:4]-FpgaPins_Fpga_TIME_rand_goal_a0[7:4],FpgaPins_Fpga_TIME_p1_ans_a0[3:0]} :
                        (FpgaPins_Fpga_TIME_p1_ans_a0[7:4]==FpgaPins_Fpga_TIME_rand_goal_a0[7:4]) ? {4'd0,FpgaPins_Fpga_TIME_p1_ans_a0[3:0]} :
                        {FpgaPins_Fpga_TIME_rand_goal_a0[7:4]-FpgaPins_Fpga_TIME_p1_ans_a0[7:4],4'd10-FpgaPins_Fpga_TIME_p1_ans_a0[3:0]}; //($p1_ans[7:4]<$rand_goal[7:4]) ?
                     assign FpgaPins_Fpga_TIME_p2_score_a0[7:0] =
                        FpgaPins_Fpga_TIME_reset_a0 || (FpgaPins_Fpga_TIME_btn_a0 == 4'd2) ? 8'd0 :
                        FpgaPins_Fpga_TIME_p2_sub_a1 ? FpgaPins_Fpga_TIME_p2_score_a1 :
                        (FpgaPins_Fpga_TIME_p2_ans_a0[7:4]>FpgaPins_Fpga_TIME_rand_goal_a0[7:4]) ? {FpgaPins_Fpga_TIME_p2_ans_a0[7:4]-FpgaPins_Fpga_TIME_rand_goal_a0[7:4],FpgaPins_Fpga_TIME_p2_ans_a0[3:0]} :
                        (FpgaPins_Fpga_TIME_p2_ans_a0[7:4]==FpgaPins_Fpga_TIME_rand_goal_a0[7:4]) ? {4'd0,FpgaPins_Fpga_TIME_p2_ans_a0[3:0]} :
                        {FpgaPins_Fpga_TIME_rand_goal_a0[7:4]-FpgaPins_Fpga_TIME_p2_ans_a0[7:4],4'd10-FpgaPins_Fpga_TIME_p2_ans_a0[3:0]}; //($p2_ans[7:4]<$rand_goal[7:4]) ?
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 277 as: m5+tt_input_labels_viz(⌈"UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED", "UNUSED"⌉)
